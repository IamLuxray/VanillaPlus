...
## Prerekvizity:
1. otevři CMD -> napiš tam:   **java -version**    -> jestli uvidíš číslo menší než 22, pokračuj na krok 2. Pokud vidíš 22+ (screenshot 1) tak přeskoč na **Instalace**.
...
4. po instalaci znovu otevři CMD -> napiš tam opět:  **java -version**    -> jestli teď neuvidíš 24, tak seš v prdeli a musíš mi napsat.
